                ...
                <div className='list'>
                    <div className='element'>
                        <a href="https://twitter.com/ssbu_elmo" target='_blank' rel='noreferrer'>
                            <img className="special" src={require('../../images/twitter-logo.png')} alt='Twitter' />
                        </a>
                    ...
                    <div className='element'>
                        <a href='https://www.youtube.com/channel/UCWJPI7TW6j_aPxpYLWAij9g/featured' target='_blank' rel='noreferrer'>
                            <img className="special" src={require('../../images/youtube-logo.png')} alt='YouTube' />
                        </a>
                    ...
                    <div className='element'>
                        <a href='https://www.twitch.tv/ssbu_elmo' target='_blank' rel='noreferrer'>
                            <img className="special" src={require('../../images/twitch-logo-2019.png')} alt='Twitch' />
                        </a>
